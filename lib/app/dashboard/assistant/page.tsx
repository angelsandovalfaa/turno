    ...
    <div className="min-h-screen flex flex-col">
      <header className="bg-primary text-primary-foreground py-3 px-6 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-xl font-bold">Panel de Ayudantía</h1>
      ...
      <main className="flex-1 container mx-auto py-6 px-4">
        ...
        <Tabs defaultValue="calendar">
          ...
          <TabsContent value="calendar" className="space-y-4">
            <AppointmentCalendar userRole="assistant" />
          </TabsContent>

          <TabsContent value="list" className="space-y-4">
            <AppointmentList userRole="assistant" />
          </TabsContent>

          <TabsContent value="chat" className="space-y-4">
            <ChatInterface sender="assistant" recipient="management" />
          </TabsContent>
        </Tabs>
